...
async function seedAccommodations(vendors: Awaited<ReturnType<typeof seedVendors>>) {
  ...
  const accommodations = [
    { name: "Erata Hotel", city: "ACCRA" as City, distanceFromVenueKm: 3.2, priceLowGHS: 600, priceHighGHS: 1200, contactPhone: "+233 30 211 2233", nearVendorId: accraVenue?.id },
    { name: "Ridge Royal Hotel", city: "ACCRA" as City, distanceFromVenueKm: 6.5, priceLowGHS: 900, priceHighGHS: 1800, contactPhone: "+233 30 211 2234", nearVendorId: accraVenue?.id },
    { name: "Somewhere Nice Guesthouse", city: "ACCRA" as City, distanceFromVenueKm: 1.8, priceLowGHS: 350, priceHighGHS: 700, contactPhone: "+233 30 211 2235", nearVendorId: accraVenue?.id },
    { name: "Golden Tulip Kumasi City", city: "KUMASI" as City, distanceFromVenueKm: 2.4, priceLowGHS: 700, priceHighGHS: 1400, contactPhone: "+233 32 202 3344", nearVendorId: kumasiVenue?.id },
    { name: "West Hills Hotel Kumasi", city: "KUMASI" as City, distanceFromVenueKm: 5.1, priceLowGHS: 500, priceHighGHS: 1000, contactPhone: "+233 32 202 3345", nearVendorId: kumasiVenue?.id },
    { name: "Noda Hotel Kumasi", city: "KUMASI" as City, distanceFromVenueKm: 4.0, priceLowGHS: 450, priceHighGHS: 900, contactPhone: "+233 32 202 3346", nearVendorId: kumasiVenue?.id },
  ];
